...
let itemsDb = {
  items: [0, 1, 2],
  byId: {
    0: {id: 0, name: 'Obsidian Rock', img: Obsidian_Rock, 
      desc: 'A rock that comes from lava', price: 10, quantity: 3},
    1: {id: 1, name: 'Red Rock', img: Red_Rock, desc: 'Likely made of iron', price: 3, quantity: 5},
    2: {id: 2, name: 'Amethyst', img: Amethyst, desc: 'Idk, but looks cool', price: 25, quantity: 8}
  }
};
